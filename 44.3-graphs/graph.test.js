...
describe("findShortestPath", function() {
  it("should return the shortest path from source to target", function() {
    let graph = new Graph();
    let S = new Node("S");
    let P = new Node("P");
    let U = new Node("U");
    ...
    var result = JSON.stringify(graph.findShortestPath(S, T));
    var validResult =
    result ===
      JSON.stringify(["S", "U", "V", "W", "T"]) ||
    result ===
      JSON.stringify(["S", "P", "Q", "R", "T"]);
